                            ...
                            <tr>
                                <td align="center" style="background-color: #4cb96b;
                                    ...
                                    <a href="#" style="text-decoration: none;">
                                        <p style="color:white;
                                                  font-weight:bold;">
                                                 <img src="images/bg-01.PNG" style="" alt="Paris" height="100" ;="">
                                            <h3>St.Mary's Basilica Church</h3>
                                        </p>
                                    </a>
                                </td>
                            </tr>
...
<table align="center" cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse; border:1 solid #55ff99;">
    ...
    <br>
     <!-- <h3>Your Mass  will be booked.</h3><br> -->
        ...
        <p> 
            <a href="http:127.0.0.1:8000//donationpayment/" target="_blank">Click to view the Donation website</a>
            </p>
