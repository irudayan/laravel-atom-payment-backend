...
<!-- <form id="search">
<center>
<label>Start Date:</label><input type="date" id="start_date" name="start_date" value="">
<label>End Date:</label><input type="date" id="end_date" name="end_date" value="">
...
function generate(e) {  
    ...
    var y = 20;  
    doc.setLineWidth(2);  
    doc.text(200, y = y + 30, "donors List"); 
